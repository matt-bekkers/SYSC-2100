...
class BoundedPriorityQueue:
    ...
    def add(self, item: any, priority: int) -> None:
        ...
        """
        if priority > len(self._queues) - 1 or priority < 0:
            raise ValueError("builtins.ValueError: add(" + str(item) + ", " + str(priority) + ": " + str(priority) + " is an invalid priority level")
